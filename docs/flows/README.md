# Diagramas de Flujo — PIV/OAC v4.0
...
| [03_fase2_entorno_control.md](03_fase2_entorno_control.md) | FASE 2: Creación del entorno de control | Master + todos los superagentes + ExecutionAuditor |
...
| [08_fase8_cierre.md](08_fase8_cierre.md) | FASE 8: Cierre, logs, métricas, engram | Audit + Standards + Compliance + Coherence + ExecutionAuditor |
